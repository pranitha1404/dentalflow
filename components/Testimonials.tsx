...
export default function Testimonials() {
  return (<section className="relative overflow-hidden bg-[#FBF9F8] pt-[120px] pb-16 md:pt-[140px] md:pb-20 lg:pb-28">

    <Scallop />

    {/* Background Glow */}
    <div className="absolute top-20 left-0 w-[350px] h-[350px] bg-[#48C9BE]/10 rounded-full blur-[120px]" />
    <div className="absolute bottom-0 right-0 w-[350px] h-[350px] bg-[#106965]/10 rounded-full blur-[120px]" />
